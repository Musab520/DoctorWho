...
Create Table tblEpisode(EpisodeId int IDENTITY(1,1),SeriesNumber int,EpisodeNumber int,EpisodeType varchar(32),Title varchar(32),EpisodeDate Date,AuthorId int,primary key (EpisodeId),Foreign Key (AuthorId) references tblAuthor(AuthorId));
